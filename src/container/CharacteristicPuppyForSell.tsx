...
interface Props{
    characteristic: Charater;
}
const CharacteristicPuppyForSellContainer: React.FC<Props> = ({characteristic}) => {
            ...
            <section className="puppies-for-sale-header">
                <div className="breadcrumbs-full">
                    <div className="ps-breadcrumbs-small column">
                        ...
                        <span className="ps-breadcrumbs-small__separator"> / </span>
                        <span className="ps-breadcrumbs-small__item"> {characteristic.title}</span>
                    </div>
                </div>
...
export default CharacteristicPuppyForSellContainer;