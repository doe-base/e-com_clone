...
const MediumFilterSidebar: React.FC<Props> = ({
    breedsArr, 
    setBreedsArr, 
    query, 
    setQuery, 
  ...
  return (
    ...
    <div id='FilterSidebar-responsive_1024' className="puppies-for-sale-filter_sidebar puppies-for-sale__filters js-filter-menu">
        {/* <div className="puppies-for-sale-filter__title">
            <div className="puppies-for-sale-filter__title__label">FILTER OPTIONS</div>
            <div className="puppies-for-sale-filter__title__close js-close-filters">
        ...
        <div className="puppies-for-sale-filter__content">
            <div className="puppies-for-sale-filter__header">
                ...
                <div>
                    <a className="js-clear-filters ab-filters-btn text-underline">
                    Reset
                    </a>
                    <a className="js-close-filters ab-filters-btn text-underline" onClick={handleCloseSidebar}>
                    Close
                    </a>
                </div>
            </div>
...
export default MediumFilterSidebar;
