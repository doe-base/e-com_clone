...
interface Props{
    ...
    breedsArr: breedsArr[];
    setBreedsArr: React.Dispatch<React.SetStateAction<breedsArr[]>>;
}
const PuppiesForSellFilterSidebar: React.FC<Props> = ({selectedBreedCheck, setSelectedBreedCheck, breedsArr, setBreedsArr}) => {
