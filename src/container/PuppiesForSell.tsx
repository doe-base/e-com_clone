...
const PuppiesForSellContainer: React.FC<Props> = ({}) => {
    ...
    console.log(selectedBreedCheck)

      // Function to handle filtering and DOM class manipulation
    const handleSelectionCheck = () => {
        // Filter items with isSelected set to true
  ...
  return (
    <div id="puppies-for-sale" className="puppies-for-sale js-puppies-for-sale">
        ...
        <section className="puppies-for-sale-header">
            ...
            <div className="puppies-for-sale-header__content">
                ...
                <section className="puppies-for-sale__seo-content seo-content mb-10">
                    <div className="seo-content__container">
                        <div className="js-readmore">
                            <div className="js-seo-readmore mobile-read-more-text-ellipsis">
                                ...
                                <span className="seo-breed-content-read-more js-readmore-trigger hidden" data-target="js-seo-readmore">Read
                ...
                <ul className="js-puppies-for-sale-header__breeds puppies-for-sale-header__breeds"></ul>
                </div>
            </div>
        </section>
        ...
        <section className="puppies-for-sale__filter-nav">
            ...
            <button className="js-open-filters puppies-for-sale__filter-open text-tangerine mobile-green-filter">
                <img src="/assets/svg/filter-icon.svg" />
                Filters
            </button>
            <button className="js-open-sort puppies-for-sale__filter-nav-sort text-tangerine ab-sorting" data-tippy="">
                ...
                <div className="puppies-for-sale-filter__content">
                    ...
                    <form id="js-filters" className="puppy-list-filter" autoComplete="off">
                        <ul className="puppy-list-filter__main">
                                                            ...
                                                            <ul ref={checkerUlLiCheckerRef} className="selectr-options" role="tree" aria-hidden="false" aria-expanded="true">
                                                                {
                                                                    ...
                                                                    null
                                                                    :
                                                                    <li ref={checkerUlLiCheckerFirstChildRef} className="selectr-option selected active" role="treeitem" tabIndex={-1} aria-selected="true">
                                                                    All Breeds
                                                                    </li> 
                            ...
                            <li className="puppy-list-filter__variety js-filter js-breed-filter hidden">
                                <div className="collapsible-panel__container js-collapsible-panel-container">
                                    <h3 className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter">
                                    <span>Variety</span>
                                    </h3>
                            ...
                            <li className="puppy-list-filter__variety-sizes js-filter js-breed-filter hidden">
                                <div className="collapsible-panel__container js-collapsible-panel-container">
                                    <h3 className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter">
                                    <span>Size</span>
                                    </h3>
                                    <div id='js-collapsible-panel_size' className="js-collapsible-panel hidden">
                                        <div className="collapsible-panel__content">
                                            <div data-filter="variety_size_id">
                                                ...
                                                <label htmlFor="variety-size-1">Miniature</label>
                                                </div>
                                                <div className="input-container" data-facet-id="2">
                                                <input type="checkbox" id="variety-size-2" value="2" name="varietySize" />
                                                <label htmlFor="variety-size-2">Medium</label>
                                                </div>
                                                <div className="input-container" data-facet-id="3">
                                                <input type="checkbox" id="variety-size-3" value="3" name="varietySize" />
                                                <label htmlFor="variety-size-3">Standard</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li className="puppy-list-filter__color js-filter">
                                <div className="collapsible-panel__container js-collapsible-panel-container">
                                    ...
                                    <div id='js-collapsible-panel_color' className="js-collapsible-panel hidden">
                                        <div className="collapsible-panel__content">
                                            <ul data-filter="puppy_color_id" className="puppy-list-filter__color-list" id="color">
