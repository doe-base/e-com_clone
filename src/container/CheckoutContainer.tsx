...
const CheckoutContainer: React.FC<Props> = ({puppyInfo, paymentInfo, subTotal, paymentOption, puppyId, paymentID, subTotalInNumber}) => {
    ...
    <div className='tw-flex tw-flex-col tw-w-full lg:tw-max-w-[711px]'>
        ...
        {/*<div className="tw-w-full tw-max-w-[816px] tw-px-6 tw-mx-auto  tw-mt-3 sm:tw-mt-5 sm:tw-hidden m_cbb4ea7e mantine-Stepper-root">
          <div 
            ...
            ata-icon-position="left" 
            data-wrap="true">
                  <button className="mantine-focus-auto m_f56b1e2c tw-flex-col tw-group tw-relative m_cbb57068 mantine-Stepper-step m_87cf2631 mantine-UnstyledButton-root" 
        ...
        <div className="tw-mt-4" style={{marginTop: '4rem'}}>
            <div className="tw-flex tw-flex-col tw-gap-[30px] tw-mb-10 initial-scroll">
                <div className="tw-px-6 sm:tw-px-0">
                  <h3 className="tw-text-green-01 tw-text-[22px] tw-font-nunito tw-font-extrabold">Payment</h3>
                ...
                <Grid container style={{alignItems: 'center', justifyContent: 'space-evenly'}}>
                  ...
                  <Grid item md={4} style={{justifyContent: 'center', alignItems: 'center', display: 'flex', marginBottom: '0.5rem'}}>
                    <a href={`/shop/checkout/${paymentID}/${puppyId}/crypto-currency`} className="crypto-button" style={{width: '98%'}}>
                        ...
                        <span className="responsive-button-text-span">Pay with Crypto</span>
                    </a>
                  </Grid>
                  <Grid item md={4} style={{justifyContent: 'center', alignItems: 'center', display: 'flex', marginBottom: '0.5rem'}}>
                    <a href={`/shop/checkout/${paymentID}/${puppyId}/bank-transfer`} className="bank-transfer-button" style={{width: '98%'}}>
                        ...
                        <span className="responsive-button-text-span">Bank Transfer</span>
                    </a>
                  </Grid>
                </Grid>

                {
                  ...
                  ?
                    <CryptoCurrency paymentInfo={paymentInfo} subTotal={subTotal} puppyId={puppyId} paymentID={paymentID} subTotalInNumber={subTotalInNumber}/>
                  :
