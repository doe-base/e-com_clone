...
const SmallFilterPopup: React.FC<Props> = ({}) => {
    ...
    const handleCloseSidebar =()=>{
        const el = document.getElementById('SmallFilterPopup-responsive_768')
        if(el){
  ...
  return (
    <div id='SmallFilterPopup-responsive_768' className="puppies-for-sale-filter_small puppies-for-sale__filters js-filter-menu">
        <div className="puppies-for-sale-filter__title">
            <div className="puppies-for-sale-filter__title__label">FILTER OPTIONS</div>
            <div className="puppies-for-sale-filter__title__close js-close-filters" onClick={handleCloseSidebar}>
            <img src="/img/puppies-for-sale-filter-close.webp" />
            </div>
        </div>
            ...
            <ul className="puppy-list-filter__main">
                ...
                <li className="puppy-list-filter__gender js-filter">
                    <div className="collapsible-panel__container js-collapsible-panel-container">
                        <h3
                            id='js-collapsible-panel_gender-btn_small' 
                            className="js-collapsible-panel-handle collapsible-panel__handle js-puppy-list-filter desktop-collapsible-open open"
                            onClick={handleGender}
                        >
                            <span>Gender</span>
                        </h3>
                        <div id='js-collapsible-panel_gender_small' className="js-collapsible-panel" style={{paddingBottom: '15px'}}>
                ...
                <li className="puppy-list-filter__breed js-filter">
                    <div className="collapsible-panel__container js-collapsible-panel-container">
                        <h2 
                            id='js-collapsible-panel_breed-btn_small' 
                            className="js-collapsible-panel-handle collapsible-panel__handle js-puppy-list-filter desktop-collapsible-open open"
                            onClick={handleBreed}
                        >
                            <span>Breed</span>
                        </h2>
                        <div id='js-collapsible-panel_breed_small' className="js-collapsible-panel" style={{paddingBottom: '15px'}}>
                            <div className="collapsible-panel__content">
                                    ...
                                    <div className="selectr-container breed-selectr selectr-desktop multiple has-selected open" style={{width: "100%"}}>
                                        ...
                                        <div className="selectr-options-container">
                                            <div className="selectr-input-container">
                                                ...
                                                <div className="selectr-notice" style={{borderTop: 'none'}}></div>
                                                <ul ref={checkerUlLiCheckerRef} className="selectr-options" role="tree" aria-hidden="false" aria-expanded="true">
                                                    ...
                                                    }
                                                    {
                                                        ...
                                                        :
                                                        <div className="selectr-notice" style={{borderTop: 'none'}}>No results.</div>
                                                    }
                                                </ul>
                                        </div>
                ...
                <li className="puppy-list-filter__collection js-filter">
                    <div className="collapsible-panel__container js-collapsible-panel-container">
                        <h3 
                            id='js-collapsible-panel_characteristics-btn_small' 
                            className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter" 
                            onClick={handleCharacter}
                        >
                            <span>Characteristics</span>
                        </h3>
                        <div id='js-collapsible-panel_characteristics_small' className="js-collapsible-panel hidden" style={{paddingBottom: '15px'}}>
                            <div className="collapsible-panel__content">
                ...
                <li className={selectedBreedCheck.length <= 0 ? "puppy-list-filter__variety js-filter js-breed-filter hidden" : "puppy-list-filter__variety js-filter js-breed-filter"}  >
                    <div className="collapsible-panel__container js-collapsible-panel-container">
                        <h3 id='js-collapsible-panel_variety-btn_small' className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter" onClick={handleVariety}>
                        <span>Variety</span>
                        </h3>
                        <div id='js-collapsible-panel_variety_small' className="js-collapsible-panel hidden" style={{paddingBottom: '15px'}}>
                            <div className="collapsible-panel__content">
                ...
                <li className={selectedBreedCheck.length <= 0 ? "puppy-list-filter__variety-sizes js-filter js-breed-filter hidden" : "puppy-list-filter__variety-sizes js-filter js-breed-filter"}>
                    <div className="collapsible-panel__container js-collapsible-panel-container">
                        <h3 id='js-collapsible-panel_size-btn_small' className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter" onClick={handleSize}>
                        <span>Size</span>
                        </h3>
                        <div id='js-collapsible-panel_size_small' className="js-collapsible-panel hidden" style={{paddingBottom: '15px'}}>
                            <div className="collapsible-panel__content">
                ...
                <li className="puppy-list-filter__age js-filter">
                    <div className="collapsible-panel__container js-collapsible-panel-container">
                        <h3 
                            id='js-collapsible-panel_age-btn_small' 
                            className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter"
                            onClick={handleAge}
                        >
                        <span>Age</span>
                        </h3>
                        <div id='js-collapsible-panel_age_small' className="js-collapsible-panel hidden" style={{paddingBottom: '15px'}}>
                            <div className="collapsible-panel__content">
                ...
                <li className="puppy-list-filter__color js-filter">
                    <div className="collapsible-panel__container js-collapsible-panel-container">
                        <h3 
                            id='js-collapsible-panel_color-btn_small' 
                            className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter"
                            onClick={handleColor}
                        >
                            <span>Color</span>
                        </h3>
                        <div id='js-collapsible-panel_color_small' className="js-collapsible-panel hidden" style={{paddingBottom: '15px'}}>
                            <div className="collapsible-panel__content">
                ...
                <li className="puppy-list-filter__travelready js-filter">
                    <div className="collapsible-panel__container js-collapsible-panel-container" style={{borderBottom: '1px solid #ceebbd'}}>
                        <h3 
                            id='js-collapsible-panel_ready-btn_small' 
                            className="js-collapsible-panel-handle collapsible-panel__handle  js-puppy-list-filter"
                            onClick={handleReady}
                        >
                            <span>Ready To Travel</span>
                        </h3>
                        <div id='js-collapsible-panel_ready_small' className="js-collapsible-panel hidden" style={{paddingBottom: '15px'}}>
                            <div className="collapsible-panel__content">
        ...
        <div className="bottom-controls">
            <div>
            <a
                className="text-tangerine js-clear-filters reset-button"
            ...
            <div>
            <a
                className="text-tangerine js-close-filters close-button"
                href="javascript:void(0)"
            >
                DONE
            </a>
...
export default SmallFilterPopup;
