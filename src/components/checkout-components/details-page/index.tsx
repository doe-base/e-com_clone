...
const DetailsSection: React.FC<Props> = ({ puppyInfo }) => {
  ...
  return (
    ...
    <div className='tw-flex tw-flex-col tw-w-full lg:tw-max-w-[711px]'>
        ...
        <div className="tw-flex tw-flex-col tw-gap-[30px] tw-mt-7 tw-mb-10 initial-scroll">
                ...
                <fieldset className="m_eda993d3 tw-px-6 sm:tw-px-0 tw-flex tw-flex-col tw-gap-5 m_e9408a47 mantine-Fieldset-root" data-variant="unstyled"><legend className="m_74ca27fe tw-font-nunito tw-text-lg tw-font-extrabold tw-text-gray-01 tw-mb-2 m_90794832 mantine-Fieldset-legend">Enter your phone number</legend><p className="tw-font-inter tw-text-sm tw-text-gray-02">In case our team need to call you about <span className="tw-capitalize">Ellis</span>’s adoption.</p>
                    <div className="tw-w-full">
                        <div></div>
                        <div className="tw-w-full">
                            <div className="tw-h-[60px] tw-border tw-px-4 tw-rounded-[10px] aria-disabled:tw-bg-gray-05 tw-border-gray-04 false m_46b77525 mantine-InputWrapper-root" data-size="xs">
                ...
                <fieldset className="m_eda993d3 tw-px-6 sm:tw-px-0 tw-flex tw-flex-col tw-gap-5 m_e9408a47 mantine-Fieldset-root" data-variant="unstyled"><legend className="m_74ca27fe tw-font-nunito tw-text-lg tw-font-extrabold tw-text-gray-01 tw-mb-2 m_90794832 mantine-Fieldset-legend">What will be <span className="tw-capitalize">Ellis</span>'s new home address?</legend><p className="tw-font-inter tw-text-sm tw-text-gray-02">Full address is needed for <span className="tw-capitalize">Ellis</span>’s Health Certificate and to help us determine available travel programs.</p>
                    <div className="tw-w-full">
                            <div></div>
                            <div className="tw-w-full">
                                <div className="tw-h-[60px] tw-border tw-px-4 tw-rounded-[10px] aria-disabled:tw-bg-gray-05 tw-border-gray-04 false m_46b77525 mantine-InputWrapper-root" data-size="xs">
                    ...
                    <div className="m_46b77525 mantine-InputWrapper-root mantine-RadioGroup-root" data-path="age">
                        <div role="radiogroup" aria-labelledby="mantine-7z98cluo3-label">
                            <div className="tw-flex tw-gap-5"><button style={{"--card-radius":"calc(0.75rem * var(--mantine-scale))"} as React.CSSProperties } className="mantine-focus-auto tw-min-h-[80px] tw-h-5 tw-min-w-[80px] tw-w-5 data-[checked=true]:tw-bg-green-04 data-[checked=true]:tw-border-green-01 data-[checked=true]:tw-border-2 tw-flex tw-justify-center tw-items-center m_9dc8ae12 mantine-RadioCard-card m_87cf2631 mantine-UnstyledButton-root" data-with-border="true" type="button" role="radio" aria-checked="false" name="mantine-um6crajz4">
                                ...
                                </div><span className="tw-font-nunito tw-text-lg tw-font-extrabold">Yes</span></button><button style={{"--card-radius":"calc(0.75rem * var(--mantine-scale))"} as React.CSSProperties } className="mantine-focus-auto tw-min-h-[80px] tw-h-5 tw-min-w-[80px] tw-w-5 data-[checked=true]:tw-bg-green-04 data-[checked=true]:tw-border-green-01 data-[checked=true]:tw-border-2 tw-flex tw-justify-center tw-items-center m_9dc8ae12 mantine-RadioCard-card m_87cf2631 mantine-UnstyledButton-root" data-with-border="true" type="button" role="radio" aria-checked="false" name="mantine-um6crajz4">
                                <div style={{"--radio-color":"var(--mantine-color-blue-filled)"} as React.CSSProperties} className="tw-hidden m_717d7ff6 mantine-RadioIndicator-indicator"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 5 5" aria-hidden="true" className="m_3e4da632 mantine-RadioIndicator-icon"><circle cx="2.5" cy="2.5" r="2.5" fill="currentColor"></circle></svg>
                                </div><span className="tw-font-nunito tw-text-lg tw-font-extrabold">No</span></button>
                            </div>
                        </div>
                    </div>
                </fieldset>
