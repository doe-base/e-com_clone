...
const BreedPuppiesForSell: React.FC<Props> = ({}) => {
  ...
  const [breedObj, setBreedObj] = useState<Breed | undefined>(findBySlug(AllbreedList, breedSlug))
  const [allPuppies, setAllPuppies] = useState(AllPuppies)
  const [sortOption, setSortOption] = useState('Featured')
  const [breedsArr, setBreedsArr] = useState(() =>
    AllbreedList.map((breed) =>
      breed.slug === breedSlug
