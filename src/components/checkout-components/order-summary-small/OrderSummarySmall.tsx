                        ...
                        <div><h2 className="tw-font-nunito tw-font-bold tw-py-5 tw-px-6 tw-border-b tw-border-b-[#E0E0E0] tw-hidden">Summary</h2>
                            <div>
                                <div className="tw-flex tw-gap-4 tw-items-start">
                                    ...
                                    <div className="tw-flex tw-flex-col"><a className="tw-font-bold tw-capitalize tw-font-nunito tw-text-lg " href="/puppy/768727" target="_blank">Ellis</a><p className="tw-font-inter tw-text-neutral-600">Male • 23 weeks</p><p className="tw-font-inter tw-text-neutral-600 tw-capitalize">Cocker Spaniel</p><p className="tw-font-inter tw-text-neutral-600">ID # 768727</p>
                                    </div>
                                </div>
                                ...
                                <div className="tw-flex tw-flex-col tw-gap-5 ">
                                    <div>
                                        <div className="tw-flex tw-justify-between"><span className="tw-font-inter tw-capitalize">Ellis</span><span className="tw-font-inter"><span>$2,292.00</span></span>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="tw-flex tw-justify-between"><span className="tw-font-inter tw-text-gray-01">Travel</span><span className="tw-font-inter tw-text-gray-01">--</span>
                                    ...
                                    <div className="m_3eebeb36 mantine-Divider-root" data-orientation="horizontal" role="separator"></div>
                                    <div>
                                        <div className="tw-flex tw-justify-between"><span className="tw-font-inter tw-text-gray-01 tw-font-bold">Total</span><span className="tw-font-inter tw-text-gray-01 tw-font-bold"><span>$2,292.00</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
