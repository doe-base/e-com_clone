        ...
        <div id="puppies-for-sale" className="puppies-for-sale js-puppies-for-sale">
            ...
            <div className="puppies-for-sale__results">
                ...
                <div className="js-puppy-list-container puppies-for-sale__puppy-list puppy-list-small-gap auto-content">
                    <a href="https://www.puppyspot.com/puppies-for-sale/breed/goldendoodle/puppy/771124">
                        <div className="card">
                            <div className="card__display">
                                    <img 
                                        ...
                                        width="30" 
                                        height="30" 
                                        src="https://www.puppyspot.com/assets/img/video-icon.svg" 
                                    />
                                    <img 
                                        className="card__image ls-is-cached lazyloaded" 
                                        data-cy="puppy-card-image" 
                                        data-src="https://photos.puppyspot.com/4/listing/771124/photo/502984445_medium.JPG" 
                                        alt="Goldendoodle puppy for sale Snoopy, dog for sale" 
                                        width="163" 
                                        height="163" 
                                        src="https://photos.puppyspot.com/4/listing/771124/photo/502984445_medium.JPG" 
                                    />
                            </div>
                            <div className="card__details_container">
                                <div className="card__details">
                                    ...
                                    <p className="breed">Goldendoodle</p>
                                    <p className="age">11 weeks<span className="hidden">old</span></p>
                                </div>
                ...
                <div className="js-puppy-pagination-container puppies-for-sale__pagination">
                        <ul className="pagination-pagebar">
                                    <li className="current pagination-pagenumber">
                                        <a href="https://www.puppyspot.com/puppies-for-sale?maxAge=12&amp;puppy_gender=male&amp;sort=search_sort_order+asc&amp;page=1" data-page="1" data-is-current="true">
                                            1
                                        </a>
                                    </li>
                                    <li className=" pagination-pagenumber">
                                        <a href="https://www.puppyspot.com/puppies-for-sale?maxAge=12&amp;puppy_gender=male&amp;sort=search_sort_order+asc&amp;page=2" data-page="2" data-is-current="false">
                                            2
                                        </a>
                                    </li>
                                    <li className=" pagination-pagenumber">
                                        <a href="https://www.puppyspot.com/puppies-for-sale?maxAge=12&amp;puppy_gender=male&amp;sort=search_sort_order+asc&amp;page=3" data-page="3" data-is-current="false">
                                            3
                                        </a>
                                    </li>
                                    <li className=" pagination-pagenumber">
                                        <a href="https://www.puppyspot.com/puppies-for-sale?maxAge=12&amp;puppy_gender=male&amp;sort=search_sort_order+asc&amp;page=4" data-page="4" data-is-current="false">
                                            4
                                        </a>
                                    </li>

                                <li className="">
                                    <a href="https://www.puppyspot.com/puppies-for-sale?maxAge=12&amp;puppy_gender=male&amp;sort=search_sort_order+asc&amp;page=2" className="arrow pagination" rel="next" data-page="2"></a>
                                </li>
                        </ul>
                </div>
            </div>
