  ...
  return (
    ...
    <div className="editable-field__display js-editable-field__display">
        <div className="editable-field__wrapper editable-field__wrapper--error">
            <span>A link has been sent to zackjeff1010@gmail.com, please click on it to confirm your account</span>
                            <a href="javascript:void(0)" className="editable-field__action js-editable-field__action" data-action="resendVerification" data-value="zackjeff1010@gmail.com">
                    Resend link
                </a>
                <div className="loading cta invisible">
            <picture className="">
                            <img loading="lazy" alt="" id="" className="" src="/img/loader-cta.svg" />
        </picture>
    ...
    <div className="white-modal__wrapper">
        <div className="white-modal__close">
                    ...
                    <picture className="">
                            <img loading="lazy" alt="" id="" className="" src="/img/menu-close.svg" />
        </picture>
    ...
    <div className="white-modal__wrapper">
        ...
        <div className="white-modal__content">
            ...
            <p>Are you sure you want to <span className="hyperlink">remove</span> this puppy from your list of
        favorites?</p>
            <button type="button" className="button main js-confirm">
                Yes, remove
            </button>
